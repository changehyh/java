package com.changehyh.github.mr;
...
public class TestMapReduce {
    public static void main(String[] args) {
        ...
        orderList.add(new Order("java基础卷Ⅰ",9.99,20000));
        orderList.add(new Order("中性笔",1.99,2000000));
...
//        System.out.println("总金额："+totalPrice);
        ...
        // r b => r + b => a + b
        // r c => r + c => a + b + c
  //      Double totalPlice = orderList.stream().map(order -> order.getAmount() * order.getPrice()).reduce((sum, x) -> sum + x).get();
