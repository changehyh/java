package com.github.changehyh.thread;
...
public class TestThreadMethod {
    ...
    public static void code2(String[] args) {
        new Thread(()->{
            ...
            //java.time.*(新的时间API)  java.util.*(旧的时间API)
            for (int i = 0; i < 10; i++) {
                try {
                    Thread.sleep(500);
    ...
    public static void code3(String[] args) {
...
//                    }
    ...
    public static void code4(String[] args) {
    ...
    public static void code5(String[] args) {
        //2019-06-05 19:57:20
        //2019/06/05 19:57:20
        //2019年06月0日 19:57:20
...
//        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
    ...
    public static void code6(String[] args) {
...
//        thread.stop();
    ...
    public static void code7(String[] args) {
//        Thread thread1 = new Thread(()-> System.out.println
// (Thread.currentThread().getName() + "优先级"+ Thread.currentThread().getPriority()),"Thread-1");
          //1-10  1 低  5 中等  10 高
